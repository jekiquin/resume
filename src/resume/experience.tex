...
\begin{cventries}
  \cventry
    ...
    {Multivista} % Organization
    {Victoria, BC} % Location
    {Jul 2023 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item{Spearheaded the integration of Sentry to enhance error detection and resolution, ensuring issues were swiftly addressed to maintain seamless mobile application performance}
        \item{Optimized end-to-end testing methodologies using Appium and WebdriveIO for Android and iOs platforms, resulting in a notable 60\% increase in workflow efficiency}
        \item{Innovated a user-friendly mobile application using React and Cordova, simplifying project management for construction professionals worldwide}
        \item{Implemented Git hooks for automated code quality checks, including liniting, formatting, and unit testing, reinforcing robust development practices}
        \item{Facilitated agile rituals such as stand-ups and retrospectives, fostering team collaboration and continuous process improvement}
      \end{cvitems}
    }
